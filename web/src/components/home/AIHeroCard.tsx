...
export function AIHeroCard() {
  return (
    <section className="group relative overflow-hidden rounded-[2rem] bg-blue-600 p-6 text-white shadow-xl shadow-blue-900/20 transition duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-900/25">
      ...
      <div className="relative">
        ...
        <h2 className="text-4xl font-bold tracking-normal">Scan a Car</h2>
        ...
        <Link
          href="/scan"
          className="mt-7 rounded-full bg-white px-5 py-3 text-sm font-bold text-blue-700 shadow-lg shadow-blue-950/10 transition hover:scale-[1.03] hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600"
        >
          Start scan
        </Link>
      </div>
